    ...
    public class EmpInfoesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.EmpInfo != null ? 
                          ...
                          Problem("Entity set 'EmpDbContext.EmpInfo'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,EmailId,Name,DateOfJoining,PassCode")] EmpInfo empInfo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,EmailId,Name,DateOfJoining,PassCode")] EmpInfo empInfo)
        {
            if (id != empInfo.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EmpDbContext.EmpInfo'  is null.");
            }
            var empInfo = await _context.EmpInfo.FindAsync(id);
            if (empInfo != null)
            {
